...
import br.net.gvt.efika.stealer.model.service.FactoryNetworkInventoryService;
...
public class EfikaCustomerServiceV2Impl extends EfikaCustomerServiceAbstract {
    ...
    @Override
    protected InventarioRede consultarInventarioRede(EfikaCustomer cust) throws Exception {
    ...
    @Override
    protected InventarioRadius consultarInventarioRadius(EfikaCustomer cust) throws Exception {
